...
namespace TUPApp.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        {
            var experience = _context.Students
            ...
            ViewData["StudentId"] = new SelectList(experience, "ID", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Experience1,YearStarted,YearEnded,StudentId")] Experience experience)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["StudentId"] = new SelectList(emergency, "ID", "Name", experience.StudentId);
            return View(experience);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Experience1,YearStarted,YearEnded,StudentId")] Experience experience)
        {
            if (id != experience.Id)
            {
                return NotFound();
